...
<div class="tile">
  <div class="row">
    <div class="col-md-6">
      <a href="{{route('admin.publisher-email',$user->id)}}" class="btn btn-lg btn-block btn-primary" style="margin-bottom:10px;">Send Email</a>
    </div>
    <div class="col-md-6"> 
...
<div class="tile">
  ...
  <div class="tile-body">
    <form id="form" method="POST" action="{{route('admin.publisher-status', $user->id)}}" enctype="multipart/form-data">
      @csrf
      @method('put')
      <div class="row">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role="form" method="POST" action="{{route('admin.publisher-pass', $user->id)}}">
          @csrf
          @method('put')
