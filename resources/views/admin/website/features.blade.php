...
<div class="tile">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{route('admin.feature-heading')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <h2 class="text-center">Features Section Heading</h2>
                    <textarea class="form-control" name="heading">{{$front->feature_heading}}</textarea>
                </div>	
                <div class="form-group">
                    <h2 class="text-center">Features Section Details</h2>
                    <textarea class="form-control" name="details">{{$front->feature_details}}</textarea>
                </div>								
                <div class="form-group">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form role="form" method="POST" action="{{route('admin.feature-delete',$slide)}}" >
                                                @csrf
                                                @method('put')
            ...
            <div id="newSlider" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form role="form" method="POST" action="{{route('admin.feature-store')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group card card-body">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-preview fileinput-exists thumbnail" style="max-width:300px;"> </div>
                ...
                <script>
                    ...
                    $(document).ready(function(){
                        $(document).on('click','.updateButton', function(){
                            ...
                            let route = "{{url('/')}}"+'/admin/feature-update/'+ id;
