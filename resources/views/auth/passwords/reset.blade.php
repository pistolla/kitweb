...
@section('content')
<section class="contact-page-area" id="Contact" style="min-height: 100vh; background: url('{{ url('/images/logo/logo-background.jpg') }}') no-repeat center center fixed; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;">
    <div class="container">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="logo text-center">
                    ...
                    <div class="card mt-5 border-0">
                        <h2 class="card-title text-center" style="padding: 10px;"> Reset Password Now</h2>
                        <div class="card-body">
