...
<body>
    ...
    <form action="https://www.moneybookers.com/app/payment.pl" method="POST" id="payment_form">
        ...
        <input name="return_url" value="{{route('user.balance')}}" type="hidden">
        
        <input name="return_url_text" value="Return {{$gnl->title}}" type="hidden">
        
        <input name="cancel_url" value="{{route('user.balance')}}" type="hidden">
        ...
        <input name="logo_url" value="{{asset('/images/logo/logo.png')}}" type="hidden">
